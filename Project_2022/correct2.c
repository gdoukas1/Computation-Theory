...
int main()
{
    ...
    author = createPerson("Christos", "Papadimitriou", "christos.pap@gmail.com", 123456, a);
    Book b = ctor_Book;
    b = createBook("Theory of Computation", author, 50, 85.5);
    Bookstore bs = ctor_Bookstore;
    bs = createBookstore("Fototexnio");
    bs.addBook(&bs, b);
    ;
    a = createAddress("Wall Street", 10, "NY");
    author = createPerson("Dennis", "Richie", "richie@gmail.com", 987654, a);
    b = createBook("C Programming", author, 30, 75);
    bs.addBook(&bs, b);
    ;
    bs.printBookStoreBooks(&bs);
    Order ord = ctor_Order;
    ord = createOrder(orderId, b, 2, a, 1);
    orderId += 1;
    bs.putOrder(&bs, ord);
    ;
